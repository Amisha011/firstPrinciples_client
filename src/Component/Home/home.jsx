...
import backgroundImage1 from "../../asset/images/header-bg.jpg"
const Home = () => {
    console.log("bg Image",backgroundImage1)
    return (
        <div>
            <header class="header-area">
                ...
                <div id="home" class="header-hero bg_cover" style={{backgroundImage:`url(${backgroundImage1})`}}>
                    <div class="container">
